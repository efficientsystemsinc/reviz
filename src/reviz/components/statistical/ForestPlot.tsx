...
const DEFAULT_ROWS: ForestStudy[] = [
  { label: "RLHF-v1 (Anthropic)", meta: "n=4,200", estimate: 0.42, lo: 0.21, hi: 0.63, weight: 18 },
  ...
  { label: "RLAIF (Google)", meta: "n=3,400", estimate: 0.28, lo: 0.02, hi: 0.54, weight: 14 },
  ...
  presets: [
    ...
    },
    {
      ...
      props: {
        ...
        rows: [
          { label: "GSM8K", meta: "n=1,319", estimate: 0.62, lo: 0.41, hi: 0.94, weight: 22 },
          { label: "TruthfulQA", meta: "n=817", estimate: 0.74, lo: 0.52, hi: 1.05, weight: 16 },
          { label: "PopQA", meta: "n=1,400", estimate: 0.55, lo: 0.38, hi: 0.8, weight: 24 },
          { label: "FActScore", meta: "n=500", estimate: 0.88, lo: 0.55, hi: 1.42, weight: 9 },
          { label: "HotpotQA", meta: "n=1,100", estimate: 0.69, lo: 0.47, hi: 1.01, weight: 19 },
          { label: "NQ-Open", meta: "n=600", estimate: 0.95, lo: 0.61, hi: 1.48, weight: 10 },
        ],
      },
    },
    {
      ...
      props: {
        ...
        color: "",
        rows: [
          { label: "7B chat", meta: "A100", estimate: -42, lo: -58, hi: -26, weight: 20 },
          { label: "13B code", meta: "A100", estimate: -61, lo: -82, hi: -40, weight: 18 },
          { label: "34B reason", meta: "H100", estimate: -88, lo: -120, hi: -56, weight: 14 },
          { label: "70B chat", meta: "H100", estimate: -71, lo: -99, hi: -43, weight: 16 },
          { label: "MoE 8x7B", meta: "H100", estimate: -34, lo: -70, hi: 2, weight: 12 },
        ],
      },
    },
  ],
