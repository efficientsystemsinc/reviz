...
const DEFAULT_DATA: Bubble[] = [
  ...
  { x: 0.2, y: 62.1, size: 4, group: "small", label: "Aria-XS-2B" },
];
  ...
  presets: [
    ...
    },
    {
      ...
      props: {
        ...
        maxRadius: 40,
        data: [
          { x: 1.4, y: 62, size: 18, group: "web", label: "Web crawl" },
          { x: 0.8, y: 71, size: 9, group: "web", label: "Open-Web" },
          { x: 0.3, y: 88, size: 3, group: "curated", label: "Encyclopedia" },
          { x: 0.2, y: 91, size: 2, group: "curated", label: "Books" },
          { x: 0.6, y: 84, size: 5, group: "curated", label: "Papers" },
          { x: 0.4, y: 79, size: 6, group: "code", label: "Code repos" },
          { x: 0.15, y: 86, size: 4, group: "code", label: "Q&A forums" },
          { x: 2.1, y: 58, size: 24, group: "web", label: "Filtered web" },
        ],
      },
    },
    {
      ...
      props: {
        ...
        data: [
          ...
          { x: 30, y: 78, size: 40, group: "transformer", label: "Transformer BC" },
          { x: 45, y: 72, size: 25, group: "transformer", label: "Policy-v1" },
          { x: 22, y: 85, size: 90, group: "transformer", label: "Policy-v2" },
          { x: 8, y: 88, size: 60, group: "diffusion", label: "Imitation BC" },
