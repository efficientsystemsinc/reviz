...
export default function Leaderboard({
  rows = [
    { name: "GPT-5.3", score: 88.4, delta: 2.1 },
    { name: "Claude Opus 4.8", score: 87.9, delta: 3.4 },
    { name: "Gemini 3 Ultra", score: 85.2, delta: 1.2 },
    { name: "Llama 4 405B", score: 79.6, delta: -0.8 },
    { name: "Qwen3 Max", score: 77.1, delta: 4.6 },
    { name: "Mistral Large 3", score: 71.3, delta: 0.0 },
    { name: "DeepSeek V4", score: 68.9, delta: -2.3 },
  ],
  ...
  presets: [
    ...
    },
    {
      ...
      props: {
        ...
        rows: [
          { name: "Opus 4.8 + scaffold", score: 64.2, delta: 7.5 },
          { name: "GPT-5.3 Agent", score: 61.8, delta: 5.1 },
          { name: "Gemini 3 Coder", score: 54.0, delta: 3.2 },
          { name: "Devin v3", score: 48.6, delta: 1.4 },
          { name: "OpenHands", score: 41.2, delta: -1.0 },
        ],
      },
    },
    {
      ...
      props: {
        ...
        showBars: true,
        rows: [
          { name: "Haiku 4.5", score: 612, delta: 48 },
          { name: "Gemini 3 Flash", score: 540, delta: 22 },
          { name: "GPT-5.3 Mini", score: 471, delta: -12 },
          { name: "Llama 4 70B", score: 388, delta: 9 },
          { name: "Mistral Small 3", score: 305, delta: 0 },
        ],
      },
    },
  ],
