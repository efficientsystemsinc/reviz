  ...
  presets: [
    ...
    },
    {
      ...
      props: {
        ...
        maximizeY: true,
        points: [
          { x: 0.15, y: 1142, label: "Aria-S-class" },
          { x: 0.3, y: 1188 },
          { x: 0.5, y: 1205, label: "Nova-Flash" },
          { x: 0.8, y: 1196 },
          { x: 1.2, y: 1247, label: "Aria-M-class" },
          { x: 2.0, y: 1233 },
          { x: 3.0, y: 1271 },
          { x: 4.5, y: 1258 },
          { x: 6.0, y: 1294, label: "Nova-Pro" },
          { x: 9.0, y: 1281 },
          { x: 12.0, y: 1312, label: "Aria-L-class" },
          { x: 18.0, y: 1305 },
        ],
      },
    },
